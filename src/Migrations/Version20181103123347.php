 ...
 */
final class Version20181103123347 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, reference VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, is_new TINYINT(1) NOT NULL, quantity INT NOT NULL, price_individuals DOUBLE PRECISION NOT NULL, price_professionals DOUBLE PRECISION NOT NULL, type VARCHAR(255) NOT NULL, number_in_pack INT DEFAULT NULL, image_to_customize VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE shopping_cart (id INT AUTO_INCREMENT NOT NULL, customer_id INT DEFAULT NULL, command_id INT DEFAULT NULL, total_price DOUBLE PRECISION NOT NULL, product_quantity INT NOT NULL, is_confirmed TINYINT(1) NOT NULL, INDEX IDX_72AAD4F69395C3F3 (customer_id), UNIQUE INDEX UNIQ_72AAD4F633E1689A (command_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE shopping_cart_product (id INT AUTO_INCREMENT NOT NULL, shopping_cart_id INT NOT NULL, product_id INT NOT NULL, state_id INT DEFAULT NULL, quantity INT NOT NULL, is_customized TINYINT(1) DEFAULT NULL, price DOUBLE PRECISION NOT NULL, customization_image VARCHAR(255) DEFAULT NULL, INDEX IDX_FA1F5E6C45F80CD (shopping_cart_id), INDEX IDX_FA1F5E6C4584665A (product_id), INDEX IDX_FA1F5E6C5D83CC1 (state_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE state (id INT AUTO_INCREMENT NOT NULL, state_date DATETIME NOT NULL, is_full TINYINT(1) NOT NULL, is_validate TINYINT(1) NOT NULL, size INT NOT NULL, ball_quantity INT NOT NULL, is_in_production TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
